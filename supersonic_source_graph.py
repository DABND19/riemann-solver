...
if __name__ == '__main__':
    ...
    with open('supersonic_source_exact.txt') as f:
    ...
    legends = {
        'supersonic_source_1000_cells.txt': '1000 cells',
        'supersonic_source_500_cells.txt': '500 cells',
        'supersonic_source_100_cells.txt': '100 cells'
    }
    ...
    plt.savefig('pictures/supersonic_source.png')
